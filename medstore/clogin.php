...
<html lang="en">
<head>
<title>Medstore | Company Login</title>
<meta charset="utf-8">
    ...
    <div class="grid_5">
      <form id="form" action="reallogin.php" method="post" name="vform" onsubmit="return Validate()">
        ...
        <fieldset>
          ...
          <label class="company-name"> <span class="title">Company Name*</span>
...
<script type="text/javascript">
  ...
  var company_name= document.forms["vform"]["company-name"];

  var email_error = document.getElementById("email_error");
  var password_error = document.getElementById("password_error");
  var company_name = document.getElementById("company_name_error");

  email.addEventListener("blur", emailVerify, true);
  password.addEventListener("blur", passwordVerify, true);
  company_name.addEventListener("blur", company_nameVerify, true);
  ...
  if (company_name.value == "") {
    ...
    commany_name_error.textContent = "company-name is required";
    company_name.focus();
    return false;
  }
...
function company_nameVerify(){
  if (company_name.value !=  "") {
    company_name.style.border = "1px solid #5E6E66";
